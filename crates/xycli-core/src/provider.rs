//! 模型 Provider 抽象及 Anthropic、DeepSeek HTTP 适配器。
...
fn http_client() -> XycliResult<Client> {
    Client::builder()
...
async fn parse_http_response(response: reqwest::Response, provider: &str) -> XycliResult<Value> {
